...
//------------------------------------------------------------------------------
  ...
  XACT_CUE_PROPERTIES = record
    friendlyName: array [0..XACT_CUE_NAME_LENGTH-1] of AnsiChar; // Empty if the soundbank doesn't contain any friendly names
  ...
  XACT_WAVE_PROPERTIES = record
    friendlyName: array[0..WAVEBANK_ENTRYNAME_LENGTH-1] of AnsiChar; // Friendly name for the wave; empty if the wavebank doesn't contain friendly names.
