...
function D3DXGetErrorString(hr: HResult; pBuffer: PChar; BufferLen: LongWord): HResult; stdcall; external d3dx8dll name 'D3DXGetErrorStringW'; overload;
...
{$IFNDEF UNICODE}
function D3DXGetErrorString(hr: HResult): AnsiString; overload;
{$ELSE}
...
{$IFNDEF UNICODE}
function D3DXGetErrorString(hr: HResult): AnsiString;
var
  Buffer: array [0..254] of AnsiChar;
begin
  D3DXGetErrorStringA(hr, PAnsiChar(@Buffer), 255);
